...
def generate_launch_description():
    return LaunchDescription([
        ...
        # Gazebo-to-ROS bridges for payload pose and emergency landing trigger
        Node(
            package='ros_gz_bridge',
            executable='parameter_bridge',
            name='payload_and_land_bridge',
            output='screen',
            arguments=[
        ...
        Node(
            ...
            parameters=[{'target_object_id': 7, 'enable_orientation_bias': False}]  # Default for quadcopter in world_large.sdf
        ),
